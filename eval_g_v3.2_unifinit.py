...
#save_ver = '3.2_unifinit'
save_ver = './Results/g_v3.2_unifinit'
...
with tf.variable_scope("rnn_module1"):
   ...
   var_dict = {
      'cemcnnfcW1': tf.Variable(tf.random_uniform([2048, 2048], -0.08,0.08), name='cemcnnfcW1'),
      'cemcnnfcb1': tf.Variable(tf.random_uniform([2048], -0.08,0.08), name='cemcnnfcb1'),
      'ceacnnfcW1': tf.Variable(tf.random_uniform([2048, 2048], -0.08,0.08), name='ceacnnfcW1'),
      'ceacnnfcb1': tf.Variable(tf.random_uniform([2048], -0.08,0.08), name='ceacnnfcb1'),
      'cemrnnfcW1': tf.Variable(tf.random_uniform([2048, 2048], -0.08,0.08), name='cemrnnfcW1'),
      'cemrnnfcb1': tf.Variable(tf.random_uniform([2048], -0.08,0.08), name='cemrnnfcb1'),
      'cearnnfcW1': tf.Variable(tf.random_uniform([2048, 2048], -0.08,0.08), name='cearnnfcW1'),
      'cearnnfcb1': tf.Variable(tf.random_uniform([2048], -0.08,0.08), name='cearnnfcb1'),
      'gfcW1': tf.Variable(tf.random_uniform([4096, 4096], -0.08,0.08), name='gfcW1'),
      'gfcb1': tf.Variable(tf.random_uniform([4096], -0.08,0.08), name='gfcb1'),
      'gfcW2': tf.Variable(tf.random_uniform([4096, 4096], -0.08,0.08), name='gfcW2'),
      'gfcb2': tf.Variable(tf.random_uniform([4096], -0.08,0.08), name='gfcb2'),
      'gfcW3': tf.Variable(tf.random_uniform([4096, 2048], -0.08,0.08), name='gfcW3'),
      'gfcb3': tf.Variable(tf.random_uniform([2048], -0.08,0.08), name='gfcb3'),
      'gfcW4': tf.Variable(tf.random_uniform([2048, 1000], -0.08,0.08), name='gfcW4'),
      'gfcb4': tf.Variable(tf.random_uniform([1000], -0.08,0.08), name='gfcb4'),
   ...
   #cnn_out_true_n = tf.nn.batch_normalization(image,cnn_mean,cnn_var,var_dict['cnnoutbeta'],
   #   var_dict['cnnoutscale'],epsilon)
   cnn_out_true_n = image

   #rnn_mean, rnn_var = tf.nn.moments(state, [0])
   #rnn_out_true_n = tf.nn.batch_normalization(state,rnn_mean,rnn_var,var_dict['rnnoutbeta'],
...
saver = tf.train.Saver()
saver.restore(sess, "./train_g_v3.2_unifinit")
