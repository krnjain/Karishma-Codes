...
with tf.variable_scope("rnn_module1"):
   ...
   # saver.restore(sess, "./train_g_v3.1.2")
...
saver = tf.train.Saver()
saver.restore(sess, "./train_d_v3.1.2")
...
for i in range(batch_size):
   if True: #correct_ans[i]:
      ...
      if correct_ans[i]:
         ...
         print('------- INCORRECT -------')
      print('imid = ' + imid + ', qid = ' + str(question_ids[i]) + ', question = ' + qtext[i] + ', answer generated = ' + answers_out[i]['answer'])
