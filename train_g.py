...
from generator_v2 import combine_embeddings, generator_me
...
load_weights = False
save_ver = '1'
import_weight_file = 'weights_v2.1.npy'
...
if load_weights:
   ...
   var_dict = {
      'cemcnnfcW1': tf.Variable(tf.truncated_normal([2048,2048])),
      'cemcnnfcb1': tf.Variable(tf.constant(0.1, shape=[2048])),
      'ceacnnfcW1': tf.Variable(tf.truncated_normal([2048,2048])),
      'ceacnnfcb1': tf.Variable(tf.constant(0.1, shape=[2048])),
      'cemrnnfcW1': tf.Variable(tf.truncated_normal([2048,2048])),
      'cemrnnfcb1': tf.Variable(tf.constant(0.1, shape=[2048])),
      'cearnnfcW1': tf.Variable(tf.truncated_normal([2048,2048])),
      'cearnnfcb1': tf.Variable(tf.constant(0.1, shape=[2048])),
      'gfcW1': tf.Variable(tf.truncated_normal([4096+2048, 4096+2048])),
      'gfcb1': tf.Variable(tf.constant(0.1, shape=[4096+2048])),
      'gfcW2': tf.Variable(tf.truncated_normal([4096+2048, 4096*1])),
...
noise = tf.placeholder(tf.float32, (None, 2048))
...
g_true = generator_me(features_true, noise, var_dict)
